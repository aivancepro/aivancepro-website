...
- **Avantage** : très simple à comprendre et à suivre. Idéal pour les débutants et intermédiaires.
- **Avantage** : progression logique et prévisible.
- **Limite** : les qualités travaillées au début du cycle (endurance, hypertrophie) peuvent se dégrader quand on passe à la phase de force, car elles ne sont plus stimulées.
- **Limite** : les cycles sont longs, rendant la planification moins flexible.
...
- Volume : élevé (16-25 séries par groupe musculaire par semaine)
