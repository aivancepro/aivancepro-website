...
C'est la pièce maîtresse de tout home gym sérieux. Un rack à squat avec sécurités permet de réaliser en toute sûreté le squat, le [développé couché](/guides/progresser-developpe-couche/), le développé militaire, les tractions (si équipé d'une barre de traction) et bien d'autres exercices.
...
Ces séances ciblent tous les groupes musculaires majeurs. Alternez A et B sur 3 séances par semaine (ex : lundi A, mercredi B, vendredi A, puis l'inverse la semaine suivante). Appliquez une [surcharge progressive](/guides/comprendre-rpe-intensite/) en ajoutant du poids ou des reps chaque semaine.

### Avec haltères en complément

Les haltères permettent d'ajouter des exercices d'isolation et du travail unilatéral : élévations latérales, curl haltères, rowing unilatéral, fentes, développé haltères. Cela permet de passer à un split Upper/Lower ou PPL complet. Pour savoir comment bien choisir vos exercices en fonction de vos objectifs, consultez notre guide sur les [exercices polyarticulaires vs isolation](/guides/polyarticulaire-vs-isolation/).

Si vous êtes [débutant](/guides/debutant-musculation/), le programme Full Body ci-dessus est un excellent point de départ. Les intermédiaires pourront passer à un Upper/Lower 4 jours/semaine avec une [périodisation](/guides/periodisation/) adaptée.
...
**Est-ce qu'un home gym suffit pour progresser autant qu'en salle ?**
