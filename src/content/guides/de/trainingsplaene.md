---
title: "Workout Splits: Welches Trainingsprogramm sollten Sie wählen?"
description: "Full Body, Oberkörper/Unterkörper, Push/Pull/Legs oder Bro Split? Finden Sie heraus, welcher Workout Split zu Ihrem Niveau und Ihren Zielen passt."
date: "2026-03-07"
...
keywords: "Workout Split, Trainingsplan, Full Body, Oberkörper Unterkörper, Push Pull Legs, PPL, Bro Split, Trainingsprogramm"
alternates:
  fr: "https://aivancepro.fr/guides/programmes-entrainement/"
  en: "https://aivancepro.fr/en/guides/workout-splits/"
  de: "https://aivancepro.fr/de/ratgeber/trainingsplaene/"
---

Ein Workout Split beschreibt, wie Sie Ihre Muskelgruppen auf Ihre Trainingstage verteilen. Diese Wahl bestimmt Ihre Stimulationsfrequenz pro Muskel, Ihr gesamtes Wochenvolumen und Ihre [Erholungsfähigkeit](/de/ratgeber/erholung-verletzungspraevention/). Der beste Split hängt von drei Faktoren ab: Ihrer Erfahrung, Ihren Zielen und der Anzahl der Tage, die Sie tatsächlich pro Woche ins Training investieren können.

## Die wichtigsten Workout Splits

### Full Body — 3 Tage / Woche

Jede Einheit trainiert den gesamten Körper. Ideal für [Anfänger](/de/ratgeber/anfaenger-krafttraining/) und Personen mit vollem Terminkalender. Jeder Muskel wird 3-mal pro Woche stimuliert, was die Muskelproteinsynthese (MPS) bei Trainingsanfängern maximiert. Die Einheiten dauern zwischen 60 und 75 Minuten bei guter Strukturierung.
...
Wechsel zwischen Oberkörper- und Unterkörpertraining. Ausgezeichnete Balance zwischen Trainingsvolumen und [Erholung](/de/ratgeber/erholung-verletzungspraevention/). Jeder Muskel wird 2-mal pro Woche mit moderatem Volumen pro Einheit trainiert (12–16 Sätze pro Gruppe pro Woche). Die Einheiten dauern 50 bis 70 Minuten.
...
Jedes Programm verwendet die [RPE](/de/ratgeber/rpe-intensitaet-verstehen/)-Skala zur Intensitätssteuerung. RPE 7 = 3 Wiederholungen in Reserve, RPE 8 = 2 in Reserve, RPE 9 = 1 in Reserve.
...
Für **Kraft** bevorzugen Sie [Compound-Übungen](/de/ratgeber/grunduebungen-vs-isolation/) mit schweren Lasten (80–90 % des 1RM) und langen Pausen. Ein auf Kniebeuge, Bankdrücken und Kreuzheben fokussierter Full Body oder OK/UK ist am effektivsten.
...
Für eine vertiefte Auseinandersetzung mit Volumen- und Intensitätsmanagement über die Zeit lesen Sie unseren Ratgeber zur [Periodisierung](/de/ratgeber/periodisierung/).

## Progression und Evaluation

### Mindestdauer eines Programms

Behalten Sie dasselbe Programm **mindestens 8 bis 12 Wochen** bei, bevor Sie wechseln. Die ersten 2–3 Wochen dienen der neuralen Anpassung: Ihr Körper lernt die Bewegungen und Ihr tatsächlicher [RPE](/de/ratgeber/rpe-intensitaet-verstehen/) stabilisiert sich. Signifikante Fortschritte kommen zwischen Woche 4 und Woche 10.
...
3. **Tatsächlicher RPE vs. Ziel-RPE** — Wenn Ihre RPE 8 zu RPE 6 werden, ist es Zeit, das Gewicht zu erhöhen.
4. **Maße und Körpergewicht** — Für Hypertrophie messen Sie Arm-, Oberschenkel- und Brustumfang alle 4 Wochen.
5. **Schlafqualität und Erschöpfung** — Ein indirekter, aber entscheidender Indikator für Ihre Erholungsfähigkeit.

### Wann das Programm wechseln

Wechseln Sie das Programm, wenn mindestens 2 dieser Signale auftreten:

- Stagnation der Gewichte über 3 aufeinanderfolgende Wochen trotz guter [Erholung](/de/ratgeber/erholung-verletzungspraevention/) und Ernährung
...
Das Vernachlässigen der hinteren Oberschenkel, Waden, hinteren Schultern und Stabilisierungsmuskeln schafft Dysbalancen, die zu Verletzungen führen. Für jeden Satz [Druckbewegung planen Sie einen Satz Zugbewegung](/de/ratgeber/grunduebungen-vs-isolation/) ein. Ihr Push/Pull-Verhältnis sollte mindestens 1:1 betragen.
...
Programme, die online gezeigt werden, sind selten an Ihr Niveau, Ihre Proportionen und Ihre Schwachstellen angepasst. Ein Programm muss [um Ihre spezifischen Bedürfnisse herum aufgebaut werden](/de/ratgeber/trainingsplan-erstellen/). Nutzen Sie Online-Programme als Inspiration, nicht als Verschreibung.
...
> Mo: Full Body (Kniebeuge, Bankdrücken, Rudern, Schulterdrücken — 5 Übungen, 4x6–8 @ RPE 8)
> Do: Full Body (Kreuzheben, Schrägbankdrücken, Klimmzüge, Ausfallschritte — 5 Übungen, 4x8–10 @ RPE 8)
...
Der klassische PPL in 2x-Rotation. Stellen Sie sicher, dass Ihre Erholung (Schlaf, [Ernährung](/de/ratgeber/ernaehrung-training/), Stress) dem Volumen gerecht wird. Ein kompletter Ruhetag pro Woche ist nicht verhandelbar.
...
## AIVancePro wählt für Sie

Sie möchten nicht lange überlegen? Der KI-Coach von AIVancePro analysiert Ihr Profil, Ihre Verfügbarkeit und Ihre Ziele, um automatisch den optimalen Split zu erstellen. Er wählt die Übungen, passt Volumen und [RPE](/de/ratgeber/rpe-intensitaet-verstehen/) an Ihr Niveau an und entwickelt Ihr Programm im Laufe Ihrer Progression weiter — ohne dass Sie Ihre Planung alle 8 Wochen neu überdenken müssen.
