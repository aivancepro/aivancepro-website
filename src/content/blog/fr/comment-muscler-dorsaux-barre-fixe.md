...
tag: "musculation dorsaux barre fixe"
category: "musculation"
lang: "fr"
slug: "comment-muscler-dorsaux-barre-fixe"
canonical: "https://aivancepro.fr/blog/comment-muscler-dorsaux-barre-fixe/"
keywords: "comment muscler les dorsaux à la barre fixe, traction dorsaux, programme barre fixe, exercice dos barre traction"
image: "/assets/blog/comment-muscler-dorsaux-barre-fixe.webp"
author: "Theo Stanmore"
alternates:
  fr: "https://aivancepro.fr/blog/comment-muscler-dorsaux-barre-fixe/"
---
...
- Privilégier négatives + assistées
- 4 séries × 5 reps, 3 séances/sem
- Progression : ajouter 1 rep/sem ou réduire l'assistance

**Si tu fais 5-15 tractions strictes**
- Tractions pronation : 5 × 5-8
- Tractions supination : 4 × 6-10
- Traction prise neutre : 3 × 8
- 2 séances/sem

**Si tu fais 15+ tractions strictes**
- Tractions lestées (ceinture + disque/sac à dos) : 5 × 5 @ +10-20 kg
- Tractions volume : 4 × 10
- Tractions L-sit : 3 × 8
- 2 séances/sem + travail avancé (archer, weighted progressive)

## Les 5 erreurs courantes

**1. Pas d'amplitude complète.**
Bras tendus complètement en bas. Si tu fais 50% du ROM, tu manques 50% du muscle. Le bottom de la traction (dead hang) active intensément les dorsaux.

**2. Kipping (balancer) compulsif.**
Le kipping (Crossfit) augmente le nombre de reps mais réduit le stimulus dorsal pur. Acceptable en finition de séance, pas comme base.

**3. Mauvaise scapula.**
Au démarrage, abaisse les omoplates AVANT de tirer (scapular pull-up). Si tu tires juste avec les bras, c'est le biceps qui prend tout.

**4. Trop de séries de chinups (supination), pas assez de pronation.**
Le chinup est facile mais il favorise le biceps. Pour la largeur dorsale, le pronation prise large est prioritaire.

**5. Tu ne progresses pas en charge.**
Si tu fais 10 tractions strictes, tu DOIS basculer en tractions lestées. Sinon tu stagnes. Le simple poids du corps a une limite hypertrophique pour les dorsaux.

## Combien de temps pour des résultats ?

Pour un homme moyen (75 kg) qui débute à 0 traction :
- **3 mois** : 1-3 tractions strictes
- **6 mois** : 5-8 tractions strictes
- **1 an** : 12-15 tractions strictes, sensation dorsale visible
- **2-3 ans** : 20+ tractions strictes, ajout du lest, dos large net

Pour une femme moyenne (60 kg) à 0 traction :
- **6 mois** : 1-2 tractions strictes (le poids/longueur des membres compte)
- **1 an** : 5-8 tractions strictes
- **2-3 ans** : 10-15 tractions strictes

## Sans barre fixe à la maison ?

Solutions DIY :
- Barre de tractions sur porte (40-80€ Decathlon)
- Barre murale fixée (~30€ + perçage)
- Au parc public (la plupart ont des barres ou structures de street workout)
...
- 4 niveaux de progression : suspension → négative → assistée → stricte
- 7 variantes selon objectif (pronation pour largeur, supination pour biceps)
- Bras tendus complets en bas, scapular pull AVANT le tirage
- À 10 tractions strictes → lester ou stagner
- Compléter avec rowing pour l'épaisseur dorsale
