...
tag: "musculation jambes poids du corps"
category: "musculation"
lang: "fr"
slug: "comment-muscler-jambes-au-poids"
canonical: "https://aivancepro.fr/blog/comment-muscler-jambes-au-poids/"
keywords: "comment muscler les jambes au poids du corps, exercice jambe sans matériel, programme jambes maison, muscler quadriceps poids du corps"
image: "/assets/blog/comment-muscler-jambes-au-poids.webp"
author: "Theo Stanmore"
alternates:
  fr: "https://aivancepro.fr/blog/comment-muscler-jambes-au-poids/"
---
...
1. Squat bulgare : 4 × 12/jambe
2. Squat standard : 4 × 20
3. SDT roumain unilatéral : 3 × 10/jambe
4. Wall sit : 3 × 45 sec

**Séance B — Volume/endurance**
1. Squat sauté : 3 × 12
2. Fentes alternées : 3 × 12/jambe
3. Step-up : 3 × 12/jambe
4. Wall sit : 3 × 60 sec

**Séance C (optionnelle, avancé) — Unilatéral pur**
1. Pistol squat (ou progression) : 4 × 6-8/jambe
2. Squat bulgare lesté (sac à dos) : 4 × 12/jambe
3. SDT roumain unilatéral lesté : 3 × 10/jambe
...
**1. Tempo plus lent**
3-1-2-0 (3 sec descente, 1 sec en bas, 2 sec montée, 0 pause haut). Augmente time-under-tension de +50%.

**2. Lestage progressif**
Sac à dos avec 5-15 kg de poids (eau, livres, disques). Lestage progressif permet d'aller chercher la zone 8-12 reps classique.

**3. Volume**
Passer de 14 à 22-25 séries/sem est le levier le plus simple. Attention récup' (récup' nutrition + sommeil critique pour les jambes).

## Les 4 erreurs critiques

**1. Trop court en amplitude.**
Squat partiel = jambes médiocres. Descends parallèle minimum, idéalement plus bas. Si tu ne peux pas (mobilité chevilles), travaille la mobilité avant l'hypertrophie.

**2. Genoux qui rentrent en dedans.**
Knee valgus = patellar tendinopathie sur le long terme. Pousse activement les genoux vers tes orteils pendant la descente.

**3. Tronc penché en avant.**
Signe que tes mollets/chevilles sont raides ou que ton core est faible. Si tu ne peux pas garder le tronc droit en squat, travaille mobilité + planches avant d'ajouter du volume.

**4. Manquer le travail postérieur (ischios + fessiers).**
80% des programmes jambes au poids du corps survalorisent les quads (squat, lunge). Tu te retrouves avec un déséquilibre devant/derrière. Inclue toujours du SDT roumain unilatéral + glute bridges.
