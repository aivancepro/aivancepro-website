...
Pour progresser sur l'un des compound les plus populaires, consultez notre guide dédié : [Comment progresser au développé couché](/guides/progresser-developpe-couche/).
...
1. **Exercices compound lourds** (squat, développé, soulevé de terre) -- 3 à 5 séries, 3-6 reps
2. **Exercices compound accessoires** (fentes, dips, rowing haltère) -- 3 séries, 8-12 reps
3. **Exercices d'isolation** (curls, élévations, extensions) -- 2 à 3 séries, 12-20 reps
...
- **Apprentissage** : pour un débutant qui n'a pas encore la coordination pour un squat libre, la presse à cuisses permet de charger les quadriceps et fessiers en toute sécurité. Notre [guide du débutant en musculation](/guides/debutant-musculation/) détaille cette approche progressive.
...
Une douleur au bas du dos interdit temporairement le squat et le soulevé de terre ? Les **leg extensions, leg curls et hip thrusts** permettent de continuer à entraîner les jambes sans charger la colonne vertébrale. Pour gérer une intensité adaptée en période de récupération, consultez notre guide sur le [RPE et la gestion de l'intensité](/guides/comprendre-rpe-intensite/).
...
- [Guide du débutant en musculation](/guides/debutant-musculation/) -- les fondamentaux pour bien démarrer
- [Créer un programme d'entraînement efficace](/guides/creer-programme-entrainement/) -- structurer votre semaine
- [Comprendre le RPE et l'intensité](/guides/comprendre-rpe-intensite/) -- doser l'effort sur chaque série
- [Progresser au développé couché](/guides/progresser-developpe-couche/) -- maîtriser le compound roi du haut du corps
