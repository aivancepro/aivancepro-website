...
Das optimale Volumen ist individuell. Beginnen Sie am unteren Ende des Bereichs und steigern Sie schrittweise. Wenn Sie sich gut erholen und Fortschritte machen, ist das Volumen passend. Wenn Sie sich ständig müde fühlen oder Ihre Leistung nachlässt, liegen Sie wahrscheinlich über Ihrer Erholungskapazität. Mehr zum Thema Erholungsmanagement finden Sie in unserem Ratgeber zur [Erholung und Verletzungsprävention](/de/ratgeber/erholung-verletzungspraevention/).

### Die Intensität

Die Intensität bezeichnet den Prozentsatz Ihrer Maximalkraft (1RM), der bei einer Übung verwendet wird, oder praktischer ausgedrückt, die Nähe zum Muskelversagen ([RPE](/de/ratgeber/rpe-intensitaet-verstehen/)). Verschiedene Intensitätsbereiche erzeugen verschiedene Ergebnisse:
...
Ein ausgewogener Plan kombiniert in der Regel mehrere Wiederholungsbereiche. Verbundübungen eignen sich besser für schwere Lasten (6–10 Wiederholungen), während Isolationsübungen gut mit höheren Wiederholungszahlen (12–20) funktionieren. Den Unterschied zwischen diesen beiden Bewegungstypen finden Sie in unserem Ratgeber zu [Verbundübungen vs. Isolation](/de/ratgeber/verbunduebungen-vs-isolation/).
...
Jede Einheit trainiert den gesamten Körper. Ideal für [Anfänger](/de/ratgeber/anfaenger-krafttraining/) oder Personen mit maximal 3 verfügbaren Tagen.
...
Variieren Sie Gewichte und Wiederholungen innerhalb der Woche. Zum Beispiel: Montag (4x6 bei 80 %), Mittwoch (3x10 bei 70 %), Freitag (5x3 bei 85 %). Dieser Ansatz ist effektiv für erfahrene Trainierende, die nicht mehr linear Fortschritte machen. Unser Ratgeber zu den [Grundlagen der Periodisierung](/de/ratgeber/periodisierung-grundlagen/) erläutert diese verschiedenen Progressionsmodelle im Detail.
...
Gelenkschmerzen oder vergangene Verletzungen sollten Sie nicht vom Training abhalten. Das Ziel ist, Varianten zu finden, die dieselben Muskelgruppen trainieren, ohne Schmerzen auszulösen. Mehr zum Umgang mit Verletzungen finden Sie in unserem Ratgeber zur [Erholung und Verletzungsprävention](/de/ratgeber/erholung-verletzungspraevention/).
...
PPL oder ein modifizierter Oberkörper/Unterkörper-Split mit einer fünften Spezialisierungseinheit. Stellen Sie sicher, dass Ihre [Erholung](/de/ratgeber/erholung-verletzungspraevention/) (Schlaf 7 bis 9 Stunden in einem 18–20 °C kühlen Schlafzimmer, [Ernährung](/de/ratgeber/ernaehrung-muskelaufbau/) mit 1,6 bis 2,2 g Protein pro kg, Stressmanagement) diesem Trainingsvolumen entspricht.

## Die Übungsreihenfolge

Die Reihenfolge, in der Sie Ihre Übungen ausführen, hat einen erheblichen Einfluss auf Ihre Leistung:

1. **Schwere Verbundübungen zuerst**: Kniebeuge, Bankdrücken, Kreuzheben. Diese Bewegungen erfordern am meisten Energie und Konzentration.
2. **Sekundäre Verbundübungen danach**: Rudern, Schulterdrücken, Ausfallschritte.
3. **Isolationsübungen am Ende der Einheit**: Curls, Trizepsdrücken, Seitheben. Technisch weniger anspruchsvoll, können sie auch unter Ermüdung ausgeführt werden.
...
**Lösung**: Strukturieren Sie jede Einheit um 2 bis 3 Verbundübungen, ergänzt durch 1 bis 3 Isolationsübungen. Das Verhältnis sollte bei etwa 60–70 % Verbund / 30–40 % Isolation liegen. Das [Bankdrücken](/de/ratgeber/bankdruecken-verbessern/) zum Beispiel ist eine Verbundübung, die das Herzstück Ihrer „Push"-Einheit bilden sollte.
...
Absolut. Mit minimaler Ausrüstung (verstellbare Kurzhanteln und eine Bank) können Sie alle wesentlichen Bewegungsmuster abdecken. Die Substitutionsmatrix oben zeigt die verfügbaren Alternativen. Unser Ratgeber zum [Aufbau eines Home-Gyms](/de/ratgeber/home-gym/) beschreibt die empfohlene Ausrüstung im Detail. Der Vorteil eines [KI-Coachings](/de/ratgeber/persoenliches-coaching/) wie AIVancePro ist, dass es Ihren Plan an die verfügbare Ausrüstung anpassen kann.
