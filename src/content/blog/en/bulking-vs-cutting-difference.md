...
category: "workout"
lang: "en"
slug: "bulking-vs-cutting-difference"
canonical: "https://aivancepro.fr/en/blog/bulking-vs-cutting-difference/"
keywords: "bulking vs cutting, bulk or cut, muscle building phases, caloric surplus deficit, when to bulk when to cut, bodybuilding diet phases, lean bulk guide"
...
- **Protein**: 0.7-1.0 g per lb (1.6-2.2 g/kg) of bodyweight, spread across 4-5 meals
- **Carbohydrates**: 1.8-2.7 g per lb (4-6 g/kg), your primary training fuel
- **Fats**: 0.35-0.5 g per lb (0.8-1.2 g/kg), essential for hormones and recovery

Track your weight weekly. Aim for 0.5-1 lb (0.2-0.45 kg) of weight gain per week as an intermediate. Faster gains mean you're adding unnecessary fat. For a complete nutrition breakdown, check our [nutrition and training guide](/en/guides/nutrition-training/).
...
The extra calories mean you can handle more volume and recover faster between sessions. This is when you should be setting PRs and pushing your limits. Our [beginner strength training guide](/en/guides/beginner-strength-training/) covers proper progression strategies.
...
| Macronutrient | Bulking | Cutting |
|---------------|---------|---------|
| Protein | 0.7-1.0 g/lb (1.6-2.2 g/kg) | 0.9-1.1 g/lb (2.0-2.4 g/kg) |
| Carbs | 1.8-2.7 g/lb (4-6 g/kg) | 0.9-1.8 g/lb (2-4 g/kg) |
| Fats | 0.35-0.5 g/lb (0.8-1.2 g/kg) | 0.25-0.45 g/lb (0.6-1.0 g/kg) |
| Caloric Balance | +300 to +500 kcal | -300 to -500 kcal |

Protein increases during cutting to counteract the catabolic effects of the deficit. Don't eliminate carbs entirely—they fuel your workouts and preserve muscle glycogen. For detailed cutting nutrition, see our [recovery and injury prevention guide](/en/guides/recovery-injury-prevention/).
...
Cardio creates additional caloric deficit without further restricting food intake. Our [understanding RPE guide](/en/guides/understanding-rpe/) helps you autoregulate intensity based on fatigue.
...
| Factor | Choose Bulking | Choose Cutting |
|--------|----------------|----------------|
| Body Fat (Men) | < 15% | > 18-20% |
| Body Fat (Women) | < 24% | > 28-30% |
| Training Level | Beginner/intermediate | All levels |
| Primary Goal | Build muscle | Reveal muscle |
| Season | Fall/Winter | Spring/Summer |
| Current Progress | Stalled lifts | Lifts progressing |
...
This approach synchronizes your physique with the seasons: build during fall/winter when clothes hide your body, reveal during spring for summer. Check our [periodization basics guide](/en/guides/periodization-basics/) for more on planning training cycles.
...
- Caloric surplus too large (>500 calories daily)
- Neglecting protein in favor of carbs
- Reducing training intensity "to save calories"
- Extending the bulk past 20% body fat
- Ignoring food quality (junk food = inflammation and poor recovery)

### Cutting Pitfalls to Avoid

- Starting with an aggressive deficit
- Eliminating carbohydrates completely
- Excessive cardio (>5 hours weekly)
- Dropping training loads prematurely
- Cutting for too long (>16 weeks) without a diet break
...
- **Overweight individuals**: Body fat > 25% (men) or > 35% (women)
- **Returning lifters**: Muscle memory effect active
- **Maintenance-level body fat**: 12-18% (men)

If you fit one of these profiles, our [create training program guide](/en/guides/create-training-program/) will help you structure a plan optimized for recomposition.
