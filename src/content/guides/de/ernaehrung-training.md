...
1. Berechnen Sie Ihren Grundumsatz: Gewicht (kg) x 22 für Männer, Gewicht (kg) x 20 für Frauen.
2. Multiplizieren Sie mit einem Aktivitätsfaktor: 1,4 (sitzend), 1,6 (mäßig aktiv), 1,8 (sehr aktiv).
3. Passen Sie nach Ihrem Ziel an: +400 kcal für Muskelaufbau, -400 kcal für Fettabbau.
...
**Hinweise:** Beim Fettabbau wird das Protein erhöht, um die reduzierte antikatabole Wirkung des Kalorienüberschusses zu kompensieren. Bei der Rekomposition ist das Ziel, sehr nah an der Erhaltung zu bleiben, was eine hohe Proteinzufuhr und ein gut [periodisiertes](/de/ratgeber/periodisierung/) Training erfordert, um gleichzeitig Fettabbau und Muskelaufbau zu stimulieren.
...
Verteilen Sie Ihre Proteine auf 3 bis 5 Mahlzeiten pro Tag, mit mindestens 25 bis 40 g pro Mahlzeit, um die Muskelproteinsynthese zu maximieren. Der KI-Coach von [AIVancePro](https://apps.apple.com/de/app/aivancepro/id6756116760) berechnet automatisch Ihren Proteinbedarf basierend auf Ihrem Gewicht, Ihrem Ziel und Ihrem Trainingsvolumen.
...
Das anabole Fenster von 30 Minuten nach dem Training ist ein Mythos. Solange Sie innerhalb von 2 bis 3 Stunden nach Ihrer Einheit eine proteinreiche Mahlzeit zu sich nehmen, optimieren Sie die Erholung. Für mehr zum Thema Erholung deckt unser Ratgeber zur [Erholung und Verletzungsprävention](/de/ratgeber/erholung-verletzungspraevention/) alle Aspekte von Ruhe und Regeneration ab.
...
Passen Sie die Mengen an Ihren individuellen Kalorienbedarf an. Wichtig ist, Ihre Makroziele über den Tag einzuhalten, nicht Perfektion bei jeder einzelnen Mahlzeit zu erreichen. Um diese Ernährungsprinzipien mit angepasstem Training zu verbinden, erfahren Sie, wie Sie [einen effektiven Trainingsplan erstellen](/de/ratgeber/trainingsplan-erstellen/).
...
Warten Sie nach jeder Anpassung wieder 2 bis 3 Wochen, bevor Sie erneut bewerten. Geduld ist die am meisten unterschätzte Kompetenz in der Sporternährung. [AIVancePro](https://apps.apple.com/de/app/aivancepro/id6756116760) erleichtert dieses Tracking, indem es Ihr Gewicht, Ihre Trainingsleistung und Ihr Trainingsvolumen korreliert, um Ihnen anzuzeigen, wann eine Ernährungsanpassung sinnvoll ist. Zur Strukturierung Ihrer Progressionsphasen über die Zeit lesen Sie unseren Ratgeber zur [Trainingsperiodisierung](/de/ratgeber/periodisierung/).
...
**Möchten Sie Ihre Ernährung optimal auf Ihr Training abstimmen?** [AIVancePro](https://apps.apple.com/de/app/aivancepro/id6756116760) passt Ihre Ernährungsempfehlungen an Ihr Programm und Ihre Ziele an, damit jede Mahlzeit Ihren Fortschritt unterstützt. Laden Sie die App kostenlos herunter und starten Sie noch heute.
