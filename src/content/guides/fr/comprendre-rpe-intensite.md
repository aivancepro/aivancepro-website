...
Le RIR est souvent considéré comme plus intuitif pour les [débutants](/guides/debutant-musculation/) car la question « combien de répétitions aurais-je pu ajouter ? » est plus concrète que « quel était mon niveau d'effort sur 10 ? ». En pratique, les deux échelles sont interchangeables.
...
- Pour structurer un programme sur plusieurs semaines (planifier la progression) — voir notre guide sur [la périodisation](/guides/periodisation/)
...
1. **Notez le RPE après chaque série** : prenez l'habitude d'évaluer immédiatement après avoir reposé la barre. AIVancePro vous permet d'enregistrer le RPE à chaque série pour suivre votre calibration dans le temps.
