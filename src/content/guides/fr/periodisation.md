---
title: "Les bases de la périodisation"
description: "Comprendre la périodisation en musculation : linéaire, ondulée, microcycles, mésocycles et macrocycles pour structurer votre progression."
date: "2026-03-07"
...
- **Gestion de la fatigue** : alterner des phases intenses et des phases plus légères permet de récupérer sans perdre les acquis. Un bon dosage de l'effort passe aussi par la maîtrise du [RPE et de la gestion de l'intensité](/guides/comprendre-rpe-intensite/).
...
- **Prévention des blessures** : éviter de s'entraîner lourd en permanence réduit le stress sur les articulations et les tendons. Consultez notre guide sur la [récupération et la prévention des blessures](/guides/recuperation-prevention-blessures/) pour compléter votre approche.
...
- Les valeurs de volume sont indicatives : ajustez selon votre [tolérance au volume individuelle](/guides/creer-programme-entrainement/). Un débutant restera dans le bas de la fourchette (10-14 séries/muscle/semaine), un avancé pourra monter à 18-22+.
...
- La [nutrition](/guides/nutrition-musculation/) doit accompagner chaque phase : surplus de 300-500 kcal pendant les mésocycles d'hypertrophie, maintien ou léger surplus pendant la force, avec un apport en protéines constant de 1,6 à 2,2 g/kg de poids de corps.
...
Si vous débutez, commencez par le modèle linéaire. Après 1-2 ans de pratique, passez à l'ondulée hebdomadaire ou au DUP. La périodisation par blocs convient aux pratiquants avancés qui préparent des compétitions. Pour mieux comprendre comment doser l'effort dans chaque modèle, notre guide sur [le RPE et la gestion de l'intensité](/guides/comprendre-rpe-intensite/) est un complément indispensable.
...
Pour maximiser l'hypertrophie, combinez [exercices polyarticulaires et isolation](/guides/polyarticulaire-vs-isolation/) et maintenez un surplus calorique de 300-500 kcal avec 1,6-2,2 g de protéines/kg ([en savoir plus sur la nutrition](/guides/nutrition-musculation/)).
...
L'objectif est de maximiser le 1RM au squat, au [développé couché](/guides/progresser-developpe-couche/) et au soulevé de terre lors d'une compétition.
...
- La [nutrition](/guides/nutrition-musculation/) est primordiale : surplus de 300-500 kcal, protéines à 1,6-2,2 g/kg.
- L'accent est mis sur la variété des exercices et des angles ([polyarticulaires + isolation](/guides/polyarticulaire-vs-isolation/)), avec une surcharge progressive principalement via le volume.
...
- **Post-saison (2-3 sem.)** : repos actif, mobilité, [récupération](/guides/recuperation-prevention-blessures/).
...
La périodisation peut sembler complexe, mais son principe est intuitif : alterner des périodes de travail intensif et des périodes de récupération, avec une direction claire pour chaque phase. Pour tirer le meilleur parti de chaque cycle, un suivi rigoureux de votre progression est indispensable. Commencez par un modèle simple (linéaire) et évoluez vers des modèles plus sophistiqués au fur et à mesure de votre expérience. Si vous cherchez un programme concret pour débuter, consultez notre guide pour [créer votre programme d'entraînement](/guides/creer-programme-entrainement/) ou explorez nos [programmes d'entraînement types](/guides/programmes-entrainement/).
