---
title: "Combien de protéines par jour en musculation ?"
description: "Découvrez combien de protéines consommer par jour pour prendre du muscle. Apports idéaux selon votre poids et vos objectifs."
date: "2026-03-18"
dateModified: "2026-03-18"
readTime: "15 min de lecture"
tag: "protéines musculation"
category: "nutrition"
lang: "fr"
slug: "combien-proteines-par-jour-musculation"
canonical: "https://aivancepro.fr/blog/combien-proteines-par-jour-musculation/"
keywords: "combien de protéines par jour musculation, apport protéines musculation, besoins protéiques, protéines prise de masse, grammes protéines par kilo, alimentation musculation, protéines journalières"
...
Ce tableau montre clairement l'écart entre les besoins d'un sédentaire et ceux d'un sportif de force. Si tu débutes, un guide complet peut t'aider à structurer tes bases : consulte notre [guide du débutant en musculation](/guides/debutant-musculation/).
...
Pour structurer ta prise de masse efficacement, notre article [comment prendre du muscle rapidement](/blog/comment-prendre-du-muscle-rapidement/) détaille les principes essentiels.
...
1. **Petit-déjeuner (7h)** — 35 g : 3 œufs entiers + 100 g de fromage blanc 0 %
2. **Collation matinale (10h)** — 25 g : 1 shaker de whey (30 g de poudre)
3. **Déjeuner (13h)** — 40 g : 150 g de blanc de poulet + légumes + riz complet
4. **Post-entraînement (17h)** — 35 g : 1 shaker whey + 1 banane
5. **Dîner (20h)** — 35 g : 150 g de saumon + patate douce + brocolis

Cette répartition couvre les **170 g de protéines** nécessaires avec une marge. Tu trouveras des principes complémentaires dans notre [guide nutrition musculation](/guides/nutrition-musculation/).
...
Pour bien gérer ta récupération en parallèle de ta nutrition, consulte notre [guide récupération et prévention des blessures](/guides/recuperation-prevention-blessures/).
...
Il est important de noter qu'aucune étude solide chez le sujet sain ne démontre de lien entre un apport élevé en protéines (jusqu'à 3,3 g/kg) et des dommages rénaux ([source : PubMed, Antonio et al., 2024](https://pubmed.ncbi.nlm.nih.gov/)).
...
1. **Estime ton taux de masse grasse** — utilise un pli cutané, une balance impédancemètre (résultat indicatif) ou des photos de référence
2. **Calcule ta masse maigre** — Poids total × (1 - % masse grasse / 100). Exemple : 85 kg × 0,80 = 68 kg de masse maigre
3. **Choisis ton coefficient** — Prise de masse : 2,0 g/kg de masse maigre ; Maintien : 2,2 g/kg ; Sèche : 2,4-2,6 g/kg
