...
lang: "fr"
slug: "programme-full-body-3-jours"
canonical: "https://aivancepro.fr/blog/programme-full-body-3-jours/"
keywords: "programme full body 3 jours, full body débutant, programme musculation 3 jours, entraînement full body, plan muscu semaine, séance full body, programme force"
image: "/assets/blog/programme-full-body-3-jours.png"
author: "Theo Stanmore"
alternates:
  fr: "https://aivancepro.fr/blog/programme-full-body-3-jours/"
...
- **Fréquence optimale** : stimuler chaque muscle 3×/semaine exploite pleinement la fenêtre de synthèse protéique.
- **Apprentissage moteur accéléré** : tu répètes les mouvements clés plus souvent, ce qui améliore ta technique rapidement.
- **Simplicité logistique** : 3 jours en salle, 4 jours de repos ou d'activité légère — parfait pour un emploi du temps chargé.
- **Récupération suffisante** : les jours off permettent au système nerveux et aux tissus musculaires de se régénérer, réduisant le risque de blessure (voir notre [guide récupération et prévention](/guides/recuperation-prevention-blessures/)).
- **Résultats visibles** : les gains de force rapides entretiennent la motivation, facteur n°1 d'adhérence à long terme.
...
| Critère | Full body 3 jours | Split PPL 6 jours |
|---|---|---|
| Fréquence par muscle/semaine | 3× | 2× |
| Séances par semaine | 3 | 6 |
| Durée moyenne de séance | 50-70 min | 45-60 min |
| Temps de récupération entre séances | 48 h | 24 h |
| Adapté aux débutants | ✅ Excellent | ⚠️ Volume souvent excessif |
| Progression en force (12 semaines) | +27 % (étude 2024) | +19 % (étude 2024) |
| Risque de surentraînement | Faible | Modéré à élevé |
...
Cette rotation couvre le spectre complet des adaptations musculaires et nerveuses. Pour comprendre comment doser l'intensité, consulte notre [guide sur le RPE](/guides/comprendre-rpe-intensite/).
...
- **Squat barre** — 4×5 @ RPE 7-8
- **Développé couché** — 4×5 @ RPE 7-8 (voir [notre guide dédié](/guides/progresser-developpe-couche/))
- **Rowing barre** — 4×6
- **Développé militaire haltères** — 3×6
- **Soulevé de terre roumain** — 3×6
- **Curl biceps barre** — 2×8
...
- **Goblet squat** — 3×10
- **Développé incliné haltères** — 3×10 (un excellent [exercice pour les pectoraux](/blog/meilleur-exercice-pectoraux/))
- **Tirage vertical poulie** — 3×10
...
- **Pompes lestées ou dips** — 3×12-15
- **Rowing haltère unilatéral** — 3×12 chaque bras
- **Arnold press** — 3×12
- **Fentes marchées** — 3×12 chaque jambe
- **Curl marteau** — 2×15
- **Planche latérale** — 3×20-30 sec chaque côté
...
5. **Semaine 9-12** : Évalue tes progrès. Si la progression linéaire ralentit, envisage une [périodisation](/guides/periodisation/) ondulée.
...
- **Protéines** : 1,6-2,2 g/kg/jour (lire notre article sur [combien de protéines par jour](/blog/combien-proteines-par-jour-musculation/))
- **Glucides** : 3-5 g/kg/jour — ils alimentent tes séances et favorisent la récupération
- **Lipides** : 0,8-1,2 g/kg/jour — essentiels pour les hormones (testostérone, etc.)
- **Hydratation** : minimum 35 ml/kg/jour, soit environ 2,5 L pour 75 kg
- **Timing** : une dose de 20-40 g de protéines dans les 2 heures post-entraînement optimise la synthèse protéique

Pour un guide complet, consulte notre section [nutrition musculation](/guides/nutrition-musculation/).
...
|---|---|---|---|---|
| Petit-déjeuner | 3 œufs + 80 g flocons d'avoine + 1 banane | 25 g | 75 g | 18 g |
| Collation matin | 200 g yaourt grec + 30 g amandes | 20 g | 12 g | 16 g |
| Déjeuner | 150 g poulet + 200 g riz + légumes | 40 g | 65 g | 8 g |
| Collation post-training | Shaker whey (30 g) + 1 pomme | 25 g | 25 g | 2 g |
| Dîner | 150 g saumon + 200 g patates douces + salade | 35 g | 50 g | 18 g |
| **Total** | | **145 g** | **227 g** | **62 g** |
...
- **Charger trop lourd, trop vite** : ton ego n'a pas sa place sous la barre. Privilégie la technique pendant les 4 premières semaines.
- **Négliger l'échauffement** : 5-10 minutes de cardio léger + séries de chauffe réduisent le risque de blessure de **50 %** (BJSM, 2024).
- **Sauter les jambes** : un entraînement full body sans squat ni soulevé de terre prive ton corps de la plus grosse réponse hormonale anabolique.
- **Changer de programme toutes les 2 semaines** : la progression demande de la constance. Suis le même programme pendant 8 à 12 semaines minimum.
- **Dormir moins de 7 heures** : la majorité de l'hormone de croissance est sécrétée pendant le sommeil profond. Vise 7-9 h par nuit.
- **Ignorer la récupération** : les muscles ne grandissent pas pendant la séance, mais pendant le repos. Respecte tes jours off.
- **Ne pas tracker ses performances** : sans suivi, tu ne sais pas si tu progresses. Un simple carnet ou une app comme AIVancePro suffit.
...
- **Force** : tes charges augmentent-elles régulièrement ? Note tes 1RM estimées toutes les 4 semaines.
- **Volume total** : calcule ton tonnage hebdomadaire (séries × reps × charge). Il devrait augmenter de 5-10 % par mois.
- **Composition corporelle** : mesure ton tour de taille, de bras, de cuisses toutes les 4 semaines. Le poids seul ne suffit pas.
- **Qualité du sommeil et énergie** : si tu es constamment épuisé, tu en fais probablement trop.
- **Photos** : prends une photo dans les mêmes conditions (lumière, heure, posture) toutes les 4 semaines.

Pour aller plus loin dans l'analyse de tes progrès et adapter ton programme automatiquement, des outils comme **AIVancePro** peuvent tracker tes performances et suggérer des ajustements en temps réel basés sur tes données d'entraînement. Découvre comment [prendre du muscle rapidement](/blog/comment-prendre-du-muscle-rapidement/) avec les bonnes stratégies.
...
5. **Après 12 semaines** : si la progression linéaire stagne, passe à une [périodisation](/guides/periodisation/) plus avancée.
