---
title: "Comprendre le RPE et l'intensité"
description: "Échelle RPE, RIR et pourcentage de 1RM expliqués. Apprenez à doser l'intensité et à autoréguler vos séances de musculation."
date: "2026-03-07"
...
Le pourcentage de 1RM (répétition maximale) est la méthode traditionnelle pour prescrire l'intensité. Le RPE et le %1RM ne sont pas opposés mais complémentaires. Voici une correspondance approximative :

> **Correspondance RPE / %1RM / Répétitions**
>
> - 1 répétition @ RPE 10 = 100% 1RM
> - 3 répétitions @ RPE 10 = ~93% 1RM
> - 5 répétitions @ RPE 8 = ~80% 1RM
> - 5 répétitions @ RPE 10 = ~87% 1RM
> - 8 répétitions @ RPE 8 = ~72% 1RM
> - 10 répétitions @ RPE 8 = ~68% 1RM
> - 12 répétitions @ RPE 8 = ~64% 1RM
...
- Pour structurer un programme sur plusieurs semaines (planifier la progression)
...
1. Échauffez-vous progressivement en montant les charges.
2. Faites votre première série de travail et évaluez le RPE.
3. Si c'était trop facile (RPE 6-7 au lieu de 8), ajoutez 2,5 à 5 kg.
4. Si c'était trop dur (RPE 9-10 au lieu de 8), retirez 2,5 à 5 kg.
5. Notez le poids utilisé pour votre prochaine séance.
...
Si un poids qui correspond habituellement à RPE 8 se sent comme RPE 7, n'hésitez pas à ajouter un peu de poids. Ces jours sont précieux : profitez-en pour pousser légèrement au-delà de votre plan, sans dépasser le RPE cible.
...
## RPE pour les exercices d'isolation vs composés
...
- **RPE 9-10** : réservé aux tests de maxima et aux compétitions

### Exercices d'isolation (curls, élévations latérales)

Le RPE est moins précis pour les exercices d'isolation, car le concept de « répétitions en réserve » est plus flou. Sur un curl, vous pouvez souvent faire 3-4 répétitions de plus que prévu en acceptant un léger triche ou une dégradation de forme.

Pour les exercices d'isolation, visez plutôt un **RPE 8 à 9** (voire RPE 10 en fin de cycle). L'échec musculaire est moins coûteux en récupération sur un exercice d'isolation que sur un squat ou un soulevé de terre. Vous pouvez donc vous permettre de pousser plus près de l'échec sans risque de surentraînement.

## Apprendre à calibrer son RPE

La précision du RPE s'améliore avec l'expérience. Voici comment développer cette compétence :

1. **Notez le RPE après chaque série** : prenez l'habitude d'évaluer immédiatement après avoir reposé la barre.
2. **Comparez à l'échec réel** : occasionnellement, poussez une série jusqu'à l'échec (en toute sécurité, avec un pareur) pour calibrer votre perception. Si vous pensiez être à RPE 8 mais que vous avez fait 4 répétitions supplémentaires, votre RPE réel était plutôt 6.
3. **Vitesse de la barre** : apprenez à observer la vitesse de la barre. Plus elle ralentit, plus le RPE est élevé. Sur les exercices composés, la dernière répétition à RPE 8 devrait être nettement plus lente que la première.
